...
the project-scoped quest routes (rechecked 2026-09-25). Submitting an event
...
- [`references/auth-and-environment.md`](references/auth-and-environment.md): hosts, credential, onboarding, scope, reading a 401
...
2. **Draft.** Create the quest as `inactive` with the four required fields,
   ...
   route and ignores body values. Show the values it returned.
