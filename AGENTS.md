...
| `custom-blocks`                 | Custom (AI) Shop Builder blocks: when to build one, and the APIs to build it with        |
...
Build a custom block for my Shop Builder page / should this be a custom block?
→ triggers: custom-blocks
